package com.example.graduate.museumt.dialog;
...
public class PhotoSelectDialog extends PopupWindow {
    ...
    public PhotoSelectDialog(Activity context, OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.pop_bottom_dialog, null);
